  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-6">
      ...
      <p className="mt-5 max-w-2xl text-lg text-zinc-600 dark:text-zinc-400">
        Protótipo navegável da consulta, Nutrition Engine, prescrição avançada e infraestrutura clínica persistente.
      </p>
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        <Link href="/weekly-plan" className="inline-flex rounded-md border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 dark:border-zinc-700 dark:text-zinc-300">Editor semanal</Link>
        <Link href="/advanced-weekly-plan" className="inline-flex rounded-md border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 dark:border-zinc-700 dark:text-zinc-300">Prescrição avançada</Link>
        <Link href="/infrastructure" className="inline-flex rounded-md border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-medium text-emerald-800 hover:bg-emerald-100 dark:border-emerald-900 dark:bg-emerald-950/40 dark:text-emerald-300">Infraestrutura · Edição 9</Link>
      </div>
    </main>
  );
}
